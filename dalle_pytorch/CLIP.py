...
# uso CLIP per valutare quali delle 512 immagini generate sono le più precise,
# serve "solo" a ridimensionare la quantità di immagini in output selezionando le più adatte
class CLIP(nn.Module):
    ...
    def __init__(
        ...
        # genera oggetto transformer: nn con tanti layer quanti richesti da seq_len
        # necessario a trasformare il testo
    ...
    # passo di forward sul testo text
    def forward(
            self,
            text,
            image,
